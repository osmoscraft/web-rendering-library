// TODO
// data object inherit and shadow parent when used in for loop
// Support high-perf array reconciliation using keys
...
// Long term: bet on declarative shadow dom and native templating syntax

// Out of scope:
// 1. inline interpolation `{{ variableName }}` => use $text binding
// 2. sanitizer => pending browser native sanitize api
// 3. multi-operand expression: `myVar > 3` => use data binding
